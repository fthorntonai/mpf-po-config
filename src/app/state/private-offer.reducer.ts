...
let baseObject = { "offer": { "contractAmount": "0","firstInvoice":"", "offerDuration": "0", "numberOfPayments":1 ,
...
export const privateOfferReducer = createReducer(
 ...
 on(reset, (state) =>{ return { "offer" :{ "contractAmount": "0","firstInvoice":"", "offerDuration": "0","numberOfPayments":1 ,
  "paymentFrequency": "", "startDate": "", "endDate": "", "paymentAmount": "", "range": "", "jsonView": "" }}})
);
